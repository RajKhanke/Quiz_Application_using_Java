...
public class rules extends JFrame implements ActionListener {
    ...
    { 
      ...
      rules.setText(
            "<html>"+ 
                "1. This is a general knowledge quiz consisting of 20 questions." + "<br><br>" +
                "2. Each question carries 5 points, There will be no negative marking. You are free to guess the answer." + "<br><br>" +
                "3. There will be 20 seconds time duration to answer every question in the quiz."+ "<br><br>"+
