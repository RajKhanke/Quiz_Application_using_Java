...
public class rulesapti extends JFrame implements ActionListener {
    
    String name;
    JButton start,back;
    rulesapti(String name)
    { 
      this.name=name;
      ...
      rules.setText(
            "<html>"+ 
                "1. This is a Aptitude and Mathematics quiz consisting of 20 questions." + "<br><br>" +
                "2. Each question carries 5 points, There will be no negative marking. You are free to guess the answer." + "<br><br>" +
                "3. There will be 120 seconds time duration to answer every question in the quiz."+ "<br><br>"+
